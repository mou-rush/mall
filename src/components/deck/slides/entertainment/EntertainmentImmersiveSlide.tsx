        ...
        >
          {activeAttraction && (
            <>
              ...
              <div
                ref={panelRef}
                className="absolute right-0 top-0 z-40 flex h-full w-full max-w-[560px] flex-col justify-end bg-gradient-to-l from-black/90 via-black/72 to-transparent p-6 md:p-10 mb-9"
              ...
              >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-flex items-center justify-center  bg-[#FFC72C] px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-black transition hover:brightness-110"
                >
